...
- **Review:** identify the exact `subject` and a specific `concern`: the behavior, forbidden effect, or complexity claim to challenge. Ask for discrepancies and evidence, not approval. Separate independent concerns when useful rather than asking one reviewer to certify the entire change.
...
Choose verification and independent review for the affected guarantees and unresolved concerns, not a ceremonial gate. Small changes may need only inspection and established checks; nontrivial changes warrant focused independent scrutiny. Resolve findings by evidence and practical value, and verify consequential corrections. Do not rerun unrelated checks merely because another review occurred.
