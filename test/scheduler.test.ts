...
function runFixture(): WorkgraphRun {
  return {
    ...
    control: { planStatus: "approved", currentPlanVersion: 1, executionStatus: "idle", attentionStatus: "clear", verificationStatus: "absent", maxConcurrency: 2, updatedAt: new Date(0).toISOString() },
    plans: [],
    attempts: [],
